...
| renderCloseIcon  | custom close icon | ReactElement ｜ ()=>ReactElement | - |  |
| renderLeftIcon   | custom left icon | ReactElement ｜ (index)=>ReactElement | - |  |
| renderRightIcon  | custom right icon | ReactElement ｜ (index)=>ReactElement | - |  |
