...
| renderCell         | 自定义渲染勾选框                                                                                 | ({ selected: boolean, record: RecordType, index: number, originNode: JSX.Element, inHeader: boolean, disabled: boolean, indeterminate: boolean, selectRow?: (selected: boolean, e: Event) => void, selectAll?: (selected: boolean, e: Event) => void }) => ReactNode |        |      **2.52.0**     |
