...
| keyMaps | Customize the fields of value, label, children, disabled, isLeaf in the node. If keyMaps sets the custom name of label and enables search, in order to ensure the correctness of the search, treeNodeFilterProp needs to be set to one of the keys of treeData or through filterTreeNode custom search function | object | - | 2.100.0 |
