...
function visitParents(tree, test, visitor, reverse) {
  ...
  function factory(node2, index, parents) {
    ...
    function visit2() {
      ...
      let offset;
      let grandparents;
      if (!test || is4(node2, index, parents[parents.length - 1] || void 0)) {
...
function tokenizeWwwPrefix(effects, ok5, nok) {
  ...
  function wwwPrefixAfter(code3) {
    return code3 === null ? nok(code3) : ok5(code3);
  }
}
...
function tokenizeBlankLine(effects, ok5, nok) {
  ...
  function after(code3) {
    return code3 === null || markdownLineEnding(code3) ? ok5(code3) : nok(code3);
  }
}
...
function tokenizeIndent(effects, ok5, nok) {
  ...
  function afterPrefix(code3) {
    ...
    return tail && tail[1].type === "gfmFootnoteDefinitionIndent" && tail[2].sliceSerialize(tail[1], true).length === 4 ? ok5(code3) : nok(code3);
  }
}
...
// remark-gfm.js
var remark_gfm_default = remarkGfm;
