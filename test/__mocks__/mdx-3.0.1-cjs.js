...
var require_xhtml = __commonJS({
  "node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/xhtml.js"(exports2, module2) {
    module2.exports = {
      quot: '"',
      amp: "&",
      apos: "'",
...
// node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/node_modules/acorn/dist/acorn.js
var require_acorn = __commonJS({
  "node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/node_modules/acorn/dist/acorn.js"(exports2, module2) {
    (function(global, factory) {
      ...
      function kw2(name2, options) {
        ...
        return keywords$12[name2] = new TokenType3(name2, options);
      }
      var types2 = {
      ...
      function isNewLine2(code2, ecma2019String) {
      ...
      function getLineInfo2(input, offset2) {
        for (var line = 1, cur = 0; ; ) {
          ...
          var match = lineBreakG2.exec(input);
      ...
      var SCOPE_TOP2 = 1, SCOPE_FUNCTION2 = 2, SCOPE_VAR2 = SCOPE_TOP2 | SCOPE_FUNCTION2, SCOPE_ASYNC2 = 4, SCOPE_GENERATOR2 = 8, SCOPE_ARROW2 = 16, SCOPE_SIMPLE_CATCH2 = 32, SCOPE_SUPER2 = 64, SCOPE_DIRECT_SUPER2 = 128;
      ...
      Parser3.prototype.inNonArrowFunction = function inNonArrowFunction() {
      ...
      var literal2 = /^(?:'((?:\\.|[^'\\])*?)'|"((?:\\.|[^"\\])*?)")/;
      pp2.strictDirective = function(start2) {
        for (; ; ) {
      ...
      pp2.isContextual = function(name2) {
        return this.type === types2.name && this.value === name2 && !this.containsEsc;
      };
      pp2.eatContextual = function(name2) {
      ...
      pp2.expectContextual = function(name2) {
      ...
      pp$12.parseTopLevel = function(node2) {
        var exports4 = {};
        if (!node2.body) {
          node2.body = [];
        }
      ...
      pp$12.parseStatement = function(context, topLevel, exports4) {
      ...
      pp$12.parseBreakContinueStatement = function(node2, keyword) {
      ...
      pp$12.parseDebuggerStatement = function(node2) {
        this.next();
        this.semicolon();
        return this.finishNode(node2, "DebuggerStatement");
      };
      pp$12.parseDoStatement = function(node2) {
        this.next();
      ...
      pp$12.parseForStatement = function(node2) {
        this.next();
      ...
      pp$12.parseFunctionStatement = function(node2, isAsync, declarationPosition) {
        this.next();
        return this.parseFunction(node2, FUNC_STATEMENT2 | (declarationPosition ? 0 : FUNC_HANGING_STATEMENT2), false, isAsync);
      };
      pp$12.parseIfStatement = function(node2) {
        this.next();
        node2.test = this.parseParenExpression();
      ...
      pp$12.parseReturnStatement = function(node2) {
      ...
      pp$12.parseSwitchStatement = function(node2) {
        this.next();
      ...
      pp$12.parseThrowStatement = function(node2) {
        this.next();
      ...
      var empty6 = [];
      pp$12.parseTryStatement = function(node2) {
        this.next();
        ...
        if (this.type === types2._catch) {
          ...
          if (this.eat(types2.parenL)) {
            ...
            this.checkLVal(clause.param, simple ? BIND_SIMPLE_CATCH2 : BIND_LEXICAL2);
      ...
      pp$12.parseVarStatement = function(node2, kind) {
        this.next();
        this.parseVar(node2, false, kind);
        this.semicolon();
        return this.finishNode(node2, "VariableDeclaration");
      };
      pp$12.parseWhileStatement = function(node2) {
        this.next();
        node2.test = this.parseParenExpression();
        this.labels.push(loopLabel2);
      ...
      pp$12.parseWithStatement = function(node2) {
        if (this.strict) {
      ...
      pp$12.parseEmptyStatement = function(node2) {
        this.next();
        return this.finishNode(node2, "EmptyStatement");
      };
      pp$12.parseLabeledStatement = function(node2, maybeName, expr, context) {
      ...
      pp$12.parseExpressionStatement = function(node2, expr) {
        node2.expression = expr;
        this.semicolon();
        return this.finishNode(node2, "ExpressionStatement");
      };
      pp$12.parseBlock = function(createNewLexicalScope, node2, exitStrict) {
      ...
      pp$12.parseFor = function(node2, init) {
        node2.init = init;
      ...
      pp$12.parseForIn = function(node2, init) {
      ...
      pp$12.parseVar = function(node2, isFor, kind) {
        node2.declarations = [];
        node2.kind = kind;
        for (; ; ) {
      ...
      pp$12.parseFunction = function(node2, statement, allowExpressionBody, isAsync) {
      ...
      pp$12.parseClassElement = function(constructorAllowsSuper) {
        ...
        var tryContextual = function(k, noLineBreak) {
          ...
          var start2 = this$1.start, startLoc = this$1.startLoc;
          ...
          method.key = this$1.startNodeAt(start2, startLoc);
          method.key.name = k;
      ...
      pp$12.parseClassId = function(node2, isStatement) {
      ...
      pp$12.parseClassSuper = function(node2) {
        node2.superClass = this.eat(types2._extends) ? this.parseExprSubscripts() : null;
      };
      pp$12.parseExport = function(node2, exports4) {
        this.next();
      ...
      pp$12.checkExport = function(exports4, name2, pos) {
        if (!exports4) {
          return;
        }
        if (has(exports4, name2)) {
          this.raiseRecoverable(pos, "Duplicate export '" + name2 + "'");
        }
        exports4[name2] = true;
      };
      pp$12.checkPatternExport = function(exports4, pat) {
        var type = pat.type;
        if (type === "Identifier") {
      ...
      pp$12.checkVariableExport = function(exports4, decls) {
        if (!exports4) {
          return;
        }
      ...
      pp$12.parseExportSpecifiers = function(exports4) {
      ...
      pp$12.parseImport = function(node2) {
        this.next();
        if (this.type === types2.string) {
          node2.specifiers = empty6;
          node2.source = this.parseExprAtom();
        } else {
      ...
      pp$22.toAssignable = function(node2, isBinding, refDestructuringErrors) {
      ...
      pp$32.parseSubscripts = function(base, startPos, startLoc, noCalls) {
      ...
      pp$32.parseSubscript = function(base, startPos, startLoc, noCalls, maybeAsyncArrow, optionalChained) {
      ...
      pp$32.parseDynamicImport = function(node2) {
        this.next();
      ...
      pp$32.parseImportMeta = function(node2) {
        this.next();
      ...
      pp$32.parseNew = function() {
        ...
        if (this.eat(types2.parenL)) {
          ...
          node2.arguments = empty$12;
        }
        return this.finishNode(node2, "NewExpression");
      };
      pp$32.parseTemplateElement = function(ref3) {
      ...
      pp$32.parseTemplate = function(ref3) {
        if (ref3 === void 0) ref3 = {};
        var isTagged = ref3.isTagged;
      ...
      pp$32.initFunction = function(node2) {
        node2.id = null;
        if (this.options.ecmaVersion >= 6) {
      ...
      pp$32.parseArrowExpression = function(node2, params, isAsync) {
        var oldYieldPos = this.yieldPos, oldAwaitPos = this.awaitPos, oldAwaitIdentPos = this.awaitIdentPos;
      ...
      pp$32.parseFunctionBody = function(node2, isArrowFunction, isMethod) {
      ...
      pp$32.checkParams = function(node2, allowDuplicates) {
        var nameHash = {};
      ...
      pp$32.checkUnreserved = function(ref3) {
      ...
      pp$52.declareName = function(name2, bindingType, pos) {
      ...
      pp$62.finishNode = function(node2, type) {
        return finishNodeAt2.call(this, node2, type, this.lastTokEnd, this.lastTokEndLoc);
      };
      pp$62.finishNodeAt = function(node2, type, pos, loc) {
      ...
      var RegExpValidationState3 = function RegExpValidationState4(parser) {
        ...
        this.unicodeProperties = data2[parser.options.ecmaVersion >= 11 ? 11 : parser.options.ecmaVersion];
        this.source = "";
        this.flags = "";
        this.start = 0;
        this.switchU = false;
      ...
      pp$82.regexp_validateUnicodePropertyNameAndValue = function(state, name2, value) {
      ...
      pp$82.regexp_eatFixedHexDigits = function(state, length) {
        var start2 = state.pos;
        state.lastIntValue = 0;
      ...
      pp$92.readToken = function(code2) {
      ...
      pp$92.readToken_mult_modulo_exp = function(code2) {
        var next = this.input.charCodeAt(this.pos + 1);
        var size = 1;
        var tokentype = code2 === 42 ? types2.star : types2.modulo;
      ...
      pp$92.readToken_pipe_amp = function(code2) {
        var next = this.input.charCodeAt(this.pos + 1);
        if (next === code2) {
          ...
          return this.finishOp(code2 === 124 ? types2.logicalOR : types2.logicalAND, 2);
        }
        if (next === 61) {
          return this.finishOp(types2.assign, 2);
        }
        return this.finishOp(code2 === 124 ? types2.bitwiseOR : types2.bitwiseAND, 1);
      };
      ...
      pp$92.readToken_plus_min = function(code2) {
        var next = this.input.charCodeAt(this.pos + 1);
        if (next === code2) {
      ...
      pp$92.readToken_lt_gt = function(code2) {
        var next = this.input.charCodeAt(this.pos + 1);
        var size = 1;
        if (next === code2) {
      ...
      pp$92.readToken_eq_excl = function(code2) {
        var next = this.input.charCodeAt(this.pos + 1);
        if (next === 61) {
        ...
        return this.finishOp(code2 === 61 ? types2.eq : types2.prefix, 1);
      };
      ...
      pp$92.getTokenFromCode = function(code2) {
        switch (code2) {
          case 46:
      ...
      pp$92.invalidStringToken = function(position3, message) {
...
var require_acorn_jsx = __commonJS({
  "node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/hast-util-to-estree/node_modules/style-to-object/index.js
var require_style_to_object = __commonJS({
  "node_modules/hast-util-to-estree/node_modules/style-to-object/index.js"(exports2, module2) {
...
// node_modules/@mdx-js/mdx/node_modules/vfile/lib/minpath.js
// var import_node_path = __toESM(require("node:path"), 1);

// node_modules/@mdx-js/mdx/node_modules/vfile/lib/minproc.js
// var import_node_process = __toESM(require("node:process"), 1);

// node_modules/@mdx-js/mdx/node_modules/vfile/lib/minurl.js
...
// node_modules/mdast-util-mdx-jsx/node_modules/character-reference-invalid/index.js
...
// node_modules/mdast-util-mdx-jsx/node_modules/is-decimal/index.js
function isDecimal(character) {
  const code2 = typeof character === "string" ? character.charCodeAt(0) : character;
  return code2 >= 48 && code2 <= 57;
}

// node_modules/mdast-util-mdx-jsx/node_modules/is-hexadecimal/index.js
function isHexadecimal(character) {
  const code2 = typeof character === "string" ? character.charCodeAt(0) : character;
  return code2 >= 97 && code2 <= 102 || code2 >= 65 && code2 <= 70 || code2 >= 48 && code2 <= 57;
}

// node_modules/mdast-util-mdx-jsx/node_modules/is-alphabetical/index.js
function isAlphabetical(character) {
  const code2 = typeof character === "string" ? character.charCodeAt(0) : character;
  return code2 >= 97 && code2 <= 122 || code2 >= 65 && code2 <= 90;
}

// node_modules/mdast-util-mdx-jsx/node_modules/is-alphanumerical/index.js
...
// node_modules/mdast-util-mdx-jsx/node_modules/parse-entities/lib/index.js
...
function mdxExpression(options) {
  ...
  function tokenizeTextExpression(effects, ok4) {
    ...
    return start2;
    function start2(code2) {
      return factoryMdxExpression.call(self2, effects, ok4, "mdxTextExpression", "mdxTextExpressionMarker", "mdxTextExpressionChunk", acorn, acornOptions, addResult, spread, allowEmpty, true)(code2);
    }
  }
}
...
function jsxText(acorn, options) {
  ...
  function tokenizeJsxText(effects, ok4, nok) {
    return factoryTag.call(this, effects, ok4, nok, acorn, options.acornOptions, options.addResult, true, "mdxJsxTextTag", "mdxJsxTextTagMarker", "mdxJsxTextTagClosingMarker", "mdxJsxTextTagSelfClosingMarker", "mdxJsxTextTagName", "mdxJsxTextTagNamePrimary", "mdxJsxTextTagNameMemberMarker", "mdxJsxTextTagNameMember", "mdxJsxTextTagNamePrefixMarker", "mdxJsxTextTagNameLocal", "mdxJsxTextTagExpressionAttribute", "mdxJsxTextTagExpressionAttributeMarker", "mdxJsxTextTagExpressionAttributeValue", "mdxJsxTextTagAttribute", "mdxJsxTextTagAttributeName", "mdxJsxTextTagAttributeNamePrimary", "mdxJsxTextTagAttributeNamePrefixMarker", "mdxJsxTextTagAttributeNameLocal", "mdxJsxTextTagAttributeInitializerMarker", "mdxJsxTextTagAttributeValueLiteral", "mdxJsxTextTagAttributeValueLiteralMarker", "mdxJsxTextTagAttributeValueLiteralValue", "mdxJsxTextTagAttributeValueExpression", "mdxJsxTextTagAttributeValueExpressionMarker", "mdxJsxTextTagAttributeValueExpressionValue");
  }
}
  ...
  function tokenizeJsxFlow(effects, ok4, nok) {
    ...
    function end(code2) {
      ...
      return code2 === 60 ? (
        ...
        start2(code2)
      ) : code2 === 123 && expression ? effects.attempt(expression, end, nok)(code2) : code2 === null || markdownLineEnding(code2) ? ok4(code2) : nok(code2);
    }
  }
}
...
// node_modules/mdast-util-to-hast/node_modules/unist-util-visit-parents/lib/color.node.js
function color2(d) {
  return "\x1B[33m" + d + "\x1B[39m";
}
...
// node_modules/unified/node_modules/trough/lib/index.js
function trough() {
  const fns = [];
...
var VFile2 = class {
  ...
  constructor(value) {
    ...
    if (!value) {
      ...
      options = { path: value };
    } else if (typeof value === "string" || isUint8Array2(value)) {
      options = { value };
    } else {
      options = value;
    }
...
function looksLikeAValue(value) {
  return typeof value === "string" || isUint8Array3(value);
}
...
// node_modules/periscopic/node_modules/is-reference/src/index.js
  ...
  switch (param.type) {
    ...
    case "ArrayPattern":
      const handle_element = (element2) => {
        if (element2) extract_identifiers(element2, nodes);
      };
...
// node_modules/hast-util-to-estree/node_modules/style-to-object/index.mjs
...
function attachComments(tree, comments) {
  ...
  if (list3.length > 0) walk2(tree, { comments: list3, index: 0 });
}
...
// node_modules/hast-util-to-estree/node_modules/zwitch/index.js
...
// node_modules/@mdx-js/mdx/node_modules/unist-util-visit-parents/lib/color.node.js
function color3(d) {
  return "\x1B[33m" + d + "\x1B[39m";
}
...
function toResult3(value) {
  ...
  return value === null || value === void 0 ? empty5 : [value];
}
...
function rehypeRemoveRaw() {
  return function(tree) {
    visit3(tree, "raw", function(_, index2, parent) {
...
function remarkMarkAndUnravel() {
  return function(tree) {
    visit3(tree, function(node2, index2, parent) {
      let offset2 = -1;
      let all3 = true;
      let oneOrMore = false;
