        ...
        return (
            <div className='footerMini8'><img src="https://lf9-static.semi.design/obj/semi-tos/images/a5768a90-324e-11ec-b393-ab4adc2e449f.svg" className='group6' />
                <div className='links'>
                    ...
                    <a href='https://figma.com/@semi' className='figmaUIKit'>Figma UIKit</a>
                    <p className='text_d3ba282e'><a href="https://semi.design/dsm/landing" className='text_8b88424e'>{_t('footer.dsm')}</a></p>
                    <a href="https://github.com/DouyinFE/semi-design" className='github'>Github</a>
