...
const sourcePackages = [
	path.resolve(packagesDir, "semi-ui"),
	path.resolve(packagesDir, "semi-foundation"),
	path.resolve(packagesDir, "semi-icons/src"),
	path.resolve(packagesDir, "semi-icons-lab/src"),
	path.resolve(packagesDir, "semi-illustrations/src"),
	path.resolve(packagesDir, "semi-animation"),
	path.resolve(packagesDir, "semi-animation-react"),
	path.resolve(packagesDir, "semi-animation-styled"),
	path.resolve(packagesDir, "semi-json-viewer-core/src"),
];
...
export default defineConfig({
	...
	module: {
		rules: [
			...
			// 其他 packages 源码（semi-foundation, semi-icons 等）
			{
				test: /\.(jsx?|tsx?)$/,
				include: sourcePackages.filter(p => !p.includes("semi-ui")),
				use: [
					{
						loader: "builtin:swc-loader",
						options: {
