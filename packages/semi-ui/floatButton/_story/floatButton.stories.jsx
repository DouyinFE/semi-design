...
export const Single = () => {
  ...
  return (
    <>
      ...
      <FloatButton icon={<IconAIEditLevel1 />} size="small" type={"colorful"}  shape="square" style={{bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 />} size="small" type={"colorful"} style={{bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 size="small" />}  type={"colorful"}  shape="square" style={{ insetInlineEnd: 80, bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 size="small" />} type={"colorful"} style={{ insetInlineEnd: 80, bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 size="extra-large" />}  size="large" type={"colorful"}  shape="square" style={{ insetInlineEnd: 130, bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 size="extra-large" />}  size="large" type={"colorful"} style={{ insetInlineEnd: 130, bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 size="small" />}  badge={{dot: true}} size="small" type={"colorful"}  shape="square" style={{ insetInlineEnd: 200, bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 size="small" />}  badge={{dot: true}} size="small" type={"colorful"} style={{ insetInlineEnd: 200, bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 />}  badge={{dot: true}} type={"colorful"}  shape="square" style={{insetInlineEnd: 250,  bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 />}  badge={{dot: true}} type={"colorful"} style={{ insetInlineEnd: 250,  bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 size="extra-large" />}  badge={{dot: true}} size="large" type={"colorful"}  shape="square" style={{ insetInlineEnd: 300, bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 size="extra-large" />}  badge={{dot: true}} size="large" type={"colorful"} style={{ insetInlineEnd: 300, bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 size="small" />}  badge={{count: 9}} size="small" type={"colorful"}  shape="square" style={{ insetInlineEnd: 370, bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 size="small" />}  badge={{count: 9}} size="small" type={"colorful"} style={{ insetInlineEnd: 370, bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 />}  badge={{count: 'VIP', type: "danger" }} type={"colorful"}  shape="square" style={{insetInlineEnd: 420,  bottom: '170px'}} />
      <FloatButton icon={<IconAIEditLevel1 />}  badge={{count: 'VIP', type: "danger" }} type={"colorful"} style={{ insetInlineEnd: 420,  bottom: '120px'}} />
      ...
      <FloatButton icon={<IconAIEditLevel1 size="extra-large" />}  badge={{count: 1000, overflowCount: 999}} size="large" type={"colorful"}  shape="square" style={{ insetInlineEnd: 500, bottom: '240px'}} />
      <FloatButton icon={<IconAIEditLevel1 size="extra-large" />}  badge={{count: 1000, overflowCount: 999}} size="large" type={"colorful"} style={{ insetInlineEnd: 500, bottom: '170px'}} />
